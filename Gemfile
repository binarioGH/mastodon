...
gem 'hamlit-rails', '~> 0.2', '>= 0.2.3'
gem 'pg', '~> 1.4'
gem 'makara', '~> 0.5', '>= 0.5.1'
gem 'pghero', '~> 3.1', '>= 3.1.0'
...
gem 'sidekiq-scheduler', '~> 5.0', '>= 5.0.0'
gem 'sidekiq-unique-jobs', '~> 7.1', '>= 7.1.27'
gem 'sidekiq-bulk', '~> 0.2.0'
gem 'simple-navigation', '~> 4.4', '>= 4.4.0'
gem 'simple_form', '~> 5.1', '>= 5.1.0'
gem 'sprockets-rails', '~> 3.4', '>= 3.4.2', require: 'sprockets/railtie'
gem 'stoplight', '~> 3.0.0'
gem 'strong_migrations', '~> 0.7', '>= 0.7.9'
...
gem 'json-ld'
gem 'json-ld-preloaded', '~> 3.2', '>= 3.2.2'
gem 'rdf-normalize', '~> 0.5'

group :development, :test do
  gem 'fabrication', '~> 2.30'
  gem 'fuubar', '~> 2.5'
  gem 'i18n-tasks', '~> 1.0', '>= 1.0.12', require: false
  gem 'pry-byebug', '~> 3.10'
  gem 'pry-rails', '~> 0.3'
...
group :development do
  ...
  gem 'rubocop-rails', '~> 2.15', '>= 2.15.0', require: false
